...
@section('content')
    <div class="d-md-flex justify-content-between align-items-center">
        ...
        <nav aria-label="breadcrumb" class="d-inline-block mt-2 mt-sm-0">
            <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                ...
                <li class="breadcrumb-item text-capitalize active" aria-current="page">Liste des Utilisateur</li>
            </ul>
        </nav>
    </div>
    ...
    <div class="mt-4">
        ...
        <div class="card border-0">
            <div class="d-flex justify-content-between p-4 shadow rounded-top">
                ...
                <div>
                    <a href="{{ route('user.create') }}" class="btn btn-md btn-pills btn-primary">
                ...
                <table class="table table-center bg-white mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="border-bottom p-3" style="min-width: 150px;">Prenom</th>
                    ...
                    <tbody>
                        @foreach ($users as $user)
                            ...
                            <tr>
                                ...
                                <td class="p-3">
                                    <a href="{{ route('user.show', $user) }}" class="text-primary">
                                        <div class="d-flex align-items-center">
                                            <span class="ms-2">{{ Str::title($user->name) }}</span>
                                        </div>
                                    </a>
                                </td>
                                <td class="p-3">
                                    <div class="d-flex align-items-center">
                                        <span class="ms-2">{{ Str::title($user->firstname) }}</span>
                                    </div>
                                    </a>
                                </td>
                                <td class="p-3">
                                    <div class="d-flex align-items-center">
                                        <span class="ms-2">{{ Str::title($user->email) }}</span>
                                    </div>
                                    </a>
                                </td>
                                ...
                                <td>
                                    <table>
                                        <td class="text-end p-1">
                                            <a href="{{ route('user.edit', $user) }}" title="Modifier"
    ...
    <!-- Delete modal Start -->
    @foreach ($users as $user)
        <x-modal-delete :model="$user" route="user" />
    @endforeach
    <!-- Delete modal End -->
@endsection
