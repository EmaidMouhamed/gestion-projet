                        ...
                        <form method="POST" action="{{ route('admin.login') }}">
                            ...
                            <div class="form-floating mb-2">
                                <input type="email" class="form-control" id="email" name="email"
                                    value="{{ old('email') }}" autofocus required placeholder="Harry">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <p class="forgot-pass mb-0">
                                    <a href="{{ route('admin.password.request') }}"
                                        class="text-dark small fw-bold">Forgot password ?
                                    </a>
                                </p>
                            </div>
                            ...
                            <div class="col-12 text-center mt-3">
                                <p class="mb-0 mt-3"><small class="text-dark me-2">Don't have an account ?</small>
                                    <a href="{{ route('admin.register') }}" class="text-dark fw-bold">Sign Up</a>
                                </p>
                            </div><!--end col-->
